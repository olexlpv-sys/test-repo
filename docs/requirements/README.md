...
Real authentication (Entra ID), Word import/export (designed for, see ../content-format.md §3), substring search inside words (full-text word/prefix search is in scope — FR-D6), attachments/images upload,

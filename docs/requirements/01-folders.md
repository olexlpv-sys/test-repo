...
- FR-F4 **[A]** Folder names are unique among siblings. A folder can be deleted only if it has no sub-folders and no documents at all (deleted ones included; admins can move documents, including deleted ones, to another folder).
